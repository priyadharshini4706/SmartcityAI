...
Original file is located at
    https://colab.research.google.com/drive/1ZdHvKpQD30zLh4-k3pOBOpkSW8Ns2zTa
"""
...
# Create Gradio interface with custom gradient and colors
with gr.Blocks() as app:
    # Custom CSS styles for gradient background and colors
    custom_css = """
    <style>
